 ...
 */
module.exports.create_kangaroo = function(table_object, n, w, r, bits) {
    const ret = wasm.create_kangaroo(table_object, n, w, r, bits);
    if (ret[2]) {
...
class WASMKangaroo {
    ...
    solve_dlp(pk) {
        ...
        const ret = wasm.wasmkangaroo_solve_dlp(this.__wbg_ptr, ptr0, len0);
...
const path = require('path').join(__dirname, 'pollard_kangaroo_bg.wasm');
